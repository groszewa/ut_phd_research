...
extern "C" {
#endif
void  hsM_0_0__array_mul_daidir (UB  * pcode, scalar  val);
void  hsM_1_0__array_mul_daidir (UB  * pcode, scalar  val);
void  hsM_2_0__array_mul_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_3_0__array_mul_daidir (UB  * pcode, scalar  val);
