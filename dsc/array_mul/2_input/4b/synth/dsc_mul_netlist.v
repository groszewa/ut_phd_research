...
module prg_4b_dual(clk, rst, en, bin_in_a, bin_in_b, sn_out_a,
...
module prg_4b_max(clk, rst, en, bin_in_a, bin_in_b, sn_out,
     ctr_overflow);
  input clk, rst, en;
  input [3:0] bin_in_a, bin_in_b;
...
module prg_4b_dual_1(clk, rst, en, bin_in_a, bin_in_b, sn_out_a,
     sn_out_b, ctr_overflow);
  input clk, rst, en;
  input [3:0] bin_in_a, bin_in_b;
  output sn_out_a, sn_out_b, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, ctr_overflow;
  wire [3:0] ctr4_out;
  comp_4b_2 comp4_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_4b_3 comp4_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
...
module prg_4b_min(clk, rst, en, bin_in_a, bin_in_b, sn_out,
  ...
  prg_4b_dual_1 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .sn_out_a (sn_out_a),
       .sn_out_b (sn_out_b), .ctr_overflow (ctr_overflow));
endmodule
...
module dsc_mul(a, b, z, clk, rst, en, ov);
  ...
  prg_4b_max prg_a(.clk (clk), .rst (rst), .en (en), .bin_in_a (a),
