...
usage -auto -elapse
set log file fv/array_mul/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/ut_phd_research/dsc/array_mul/2_input/4b/synth/../../../../shared/gscl45nm.lib
...
elaborate design -golden -root array_mul -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/array_mul/g1.v.gz
} else {
...
elaborate design -revised -root array_mul
