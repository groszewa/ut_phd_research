...
module prg_10b_max(clk, rst, en, bin_in_a, bin_in_b, sn_out,
     ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b;
  ...
  prg_10b_dual prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
...
module prg_10b_dual_1(clk, rst, en, bin_in_a, bin_in_b, sn_out_a,
     sn_out_b, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b;
  output sn_out_a, sn_out_b, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, ctr_overflow;
  wire [9:0] ctr4_out;
  comp_10b_2 comp10_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_10b_3 comp10_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  counter_WIDTH10_1 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_10b_min(clk, rst, en, bin_in_a, bin_in_b, sn_out,
     ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b;
  output sn_out, ctr_overflow;
  ...
  wire sn_out, ctr_overflow;
  wire sn_out_a, sn_out_b;
  prg_10b_dual_1 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .sn_out_a (sn_out_a),
       .sn_out_b (sn_out_b), .ctr_overflow (ctr_overflow));
...
module dsc_mul(a, b, z, clk, rst, en, ov);
  ...
  prg_10b_max prg_a(.clk (clk), .rst (rst), .en (en), .bin_in_a (a),
       .bin_in_b (b), .sn_out (sn_out_a), .ctr_overflow (ctr_ov_a));
  prg_10b_min prg_b(.clk (ctr_ov_a), .rst (rst), .en (en), .bin_in_a
