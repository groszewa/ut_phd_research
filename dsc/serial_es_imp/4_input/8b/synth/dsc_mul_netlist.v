...
module prg_8b_quad(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
  ...
  wire clk, rst, en;
  wire [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  wire sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow;
  wire [7:0] ctr4_out;
  comp_8b comp8_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_8b_1 comp8_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_8b_2 comp8_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  comp_8b_3 comp8_d(.a_gt_b (sn_out_d), .a (bin_in_d), .b (ctr4_out));
  counter_WIDTH8 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_8b_4in_max(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
  ...
  prg_8b_quad prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
...
module comp_8b_4(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED3, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_32 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED3),
       .a_larger (agt_40));
  comp_1b_33 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_34 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_35 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_36 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_37 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_38 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_39 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g27(.A (e_18), .Y (n_16));
...
module comp_8b_5(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED4, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_40 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED4),
       .a_larger (agt_40));
  comp_1b_41 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_42 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_43 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_44 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_45 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_46 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_47 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g26(.A (e_20), .Y (n_16));
  INVX1 g27(.A (e_18), .Y (n_15));
  INVX1 g28(.A (e), .Y (n_14));
...
module comp_8b_6(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED5, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  ...
  comp_1b_48 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED5),
       .a_larger (agt_40));
  comp_1b_49 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_50 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_51 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_52 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_53 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_54 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_55 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g26(.A (e_20), .Y (n_16));
  INVX1 g27(.A (e_18), .Y (n_15));
  INVX1 g28(.A (e), .Y (n_14));
...
module comp_8b_7(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED6, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_56 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED6),
       .a_larger (agt_40));
  comp_1b_57 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_58 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_59 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_60 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_61 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_62 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_63 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g27(.A (e_18), .Y (n_16));
  INVX1 g26(.A (e), .Y (n_15));
  INVX1 g28(.A (e_20), .Y (n_14));
  OAI21X1 g183(.A (n_15), .B (n_3), .C (n_5), .Y (a_gt_b));
  AOI21X1 g184(.A (e_17), .B (n_12), .C (agt), .Y (n_13));
  OAI21X1 g185(.A (n_16), .B (n_2), .C (n_6), .Y (n_12));
  AOI21X1 g186(.A (e_19), .B (n_10), .C (agt_28), .Y (n_11));
...
module prg_8b_quad_1(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     bin_in_d, sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow);
  input clk, rst, en;
  input [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  output sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow;
  wire [7:0] ctr4_out;
  comp_8b_4 comp8_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_8b_5 comp8_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_8b_6 comp8_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  comp_8b_7 comp8_d(.a_gt_b (sn_out_d), .a (bin_in_d), .b (ctr4_out));
  counter_WIDTH8_1 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_8b_4in_lowmid(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     bin_in_d, sn_out, ctr_overflow);
  input clk, rst, en;
  input [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  output sn_out, ctr_overflow;
  ...
  wire [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  wire sn_out, ctr_overflow;
  wire UNCONNECTED7, n_0, n_2, n_4, n_42, sn_out_a, sn_out_b, sn_out_c;
  wire sn_out_d;
  prg_8b_quad_1 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .bin_in_d (bin_in_d), .sn_out_a (sn_out_a), .sn_out_b
       (sn_out_b), .sn_out_c (sn_out_c), .sn_out_d (sn_out_d),
       .ctr_overflow (ctr_overflow));
  ...
  INVX1 g3(.A (n_42), .Y (n_0));
  FAX1 g2(.A (sn_out_a), .B (sn_out_b), .C (sn_out_c), .YC (n_42), .YS
       (UNCONNECTED7));
endmodule
...
module comp_8b_8(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED8, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_64 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED8),
       .a_larger (agt_40));
  comp_1b_65 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_66 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_67 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_68 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_69 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_70 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_71 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g26(.A (e_20), .Y (n_16));
  INVX1 g27(.A (e_18), .Y (n_15));
  INVX1 g28(.A (e), .Y (n_14));
...
module comp_8b_9(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED9, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_72 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED9),
       .a_larger (agt_40));
  comp_1b_73 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_74 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_75 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_76 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_77 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_78 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_79 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g27(.A (e_18), .Y (n_16));
  INVX1 g28(.A (e), .Y (n_15));
  INVX1 g26(.A (e_20), .Y (n_14));
...
module comp_8b_10(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED10, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_80 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED10),
       .a_larger (agt_40));
  comp_1b_81 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_82 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_83 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_84 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_85 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_86 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_87 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g26(.A (e_20), .Y (n_16));
  INVX1 g27(.A (e_18), .Y (n_15));
  INVX1 g28(.A (e), .Y (n_14));
...
module comp_8b_11(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED11, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_88 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED11),
       .a_larger (agt_40));
  comp_1b_89 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_90 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_91 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_92 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_93 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_94 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_95 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g27(.A (e_18), .Y (n_16));
  INVX1 g28(.A (e), .Y (n_15));
  INVX1 g26(.A (e_20), .Y (n_14));
...
module prg_8b_quad_2(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     bin_in_d, sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow);
  input clk, rst, en;
  input [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  output sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow;
  wire [7:0] ctr4_out;
  comp_8b_8 comp8_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_8b_9 comp8_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_8b_10 comp8_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  comp_8b_11 comp8_d(.a_gt_b (sn_out_d), .a (bin_in_d), .b (ctr4_out));
  counter_WIDTH8_2 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_8b_4in_highmid(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     bin_in_d, sn_out, ctr_overflow);
  input clk, rst, en;
  input [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  output sn_out, ctr_overflow;
  ...
  prg_8b_quad_2 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .bin_in_d (bin_in_d), .sn_out_a (sn_out_a), .sn_out_b
       (sn_out_b), .sn_out_c (sn_out_c), .sn_out_d (sn_out_d),
       .ctr_overflow (ctr_overflow));
...
module comp_8b_12(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED12, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_96 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED12),
       .a_larger (agt_40));
  comp_1b_97 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_98 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_99 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_100 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_101 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_102 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_103 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g26(.A (e_20), .Y (n_16));
  INVX1 g27(.A (e_18), .Y (n_15));
  INVX1 g28(.A (e), .Y (n_14));
...
module comp_8b_13(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED13, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_104 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED13),
       .a_larger (agt_40));
  comp_1b_105 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_106 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_107 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_108 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_109 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_110 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_111 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g28(.A (e_20), .Y (n_16));
  INVX1 g26(.A (e_18), .Y (n_15));
  INVX1 g27(.A (e), .Y (n_14));
  OAI21X1 g183(.A (n_14), .B (n_3), .C (n_5), .Y (a_gt_b));
  AOI21X1 g184(.A (e_17), .B (n_12), .C (agt), .Y (n_13));
  OAI21X1 g185(.A (n_15), .B (n_2), .C (n_6), .Y (n_12));
  AOI21X1 g186(.A (e_19), .B (n_10), .C (agt_28), .Y (n_11));
...
module comp_8b_14(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED14, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_112 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED14),
       .a_larger (agt_40));
  comp_1b_113 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_114 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_115 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_116 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_117 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_118 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_119 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g26(.A (e_20), .Y (n_16));
  INVX1 g27(.A (e_18), .Y (n_15));
  INVX1 g28(.A (e), .Y (n_14));
...
module comp_8b_15(a_gt_b, a, b);
  input [7:0] a, b;
  output a_gt_b;
  wire [7:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED15, agt, agt_23, agt_25, agt_28, agt_31, agt_34,
       agt_37;
  wire agt_40, e, e_17, e_18, e_19, e_20, e_21, e_22;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16;
  comp_1b_120 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED15),
       .a_larger (agt_40));
  comp_1b_121 comp1(.a (a[1]), .b (b[1]), .equal (e_22), .a_larger
       (agt_37));
  comp_1b_122 comp2(.a (a[2]), .b (b[2]), .equal (e_21), .a_larger
       (agt_34));
  comp_1b_123 comp3(.a (a[3]), .b (b[3]), .equal (e_20), .a_larger
       (agt_31));
  comp_1b_124 comp4(.a (a[4]), .b (b[4]), .equal (e_19), .a_larger
       (agt_28));
  comp_1b_125 comp5(.a (a[5]), .b (b[5]), .equal (e_18), .a_larger
       (agt_25));
  comp_1b_126 comp6(.a (a[6]), .b (b[6]), .equal (e_17), .a_larger
       (agt));
  comp_1b_127 comp7(.a (a[7]), .b (b[7]), .equal (e), .a_larger
       (agt_23));
  INVX1 g28(.A (e_20), .Y (n_16));
  INVX1 g27(.A (e_18), .Y (n_15));
...
module prg_8b_quad_3(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     bin_in_d, sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow);
  input clk, rst, en;
  input [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  output sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, sn_out_d, ctr_overflow;
  wire [7:0] ctr4_out;
  comp_8b_12 comp8_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_8b_13 comp8_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_8b_14 comp8_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  comp_8b_15 comp8_d(.a_gt_b (sn_out_d), .a (bin_in_d), .b (ctr4_out));
  counter_WIDTH8_3 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_8b_4in_min(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     bin_in_d, sn_out, ctr_overflow);
  input clk, rst, en;
  input [7:0] bin_in_a, bin_in_b, bin_in_c, bin_in_d;
  output sn_out, ctr_overflow;
  ...
  prg_8b_quad_3 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .bin_in_d (bin_in_d), .sn_out_a (sn_out_a), .sn_out_b
       (sn_out_b), .sn_out_c (sn_out_c), .sn_out_d (sn_out_d),
       .ctr_overflow (ctr_overflow));
...
module counter_WIDTH32(out, clk, en, rst, overflow);
  ...
  increment_unsigned inc_add_36_16_1(.A (out), .CI (1'b1), .Z ({n_164,
       ...
       n_126, n_127, n_128, UNCONNECTED16}));
...
module dsc_mul(a, b, c, d, z, clk, rst, en, ov);
  ...
  prg_8b_4in_max prg_a(.clk (clk), .rst (rst), .en (en), .bin_in_a (a),
       .bin_in_b (b), .bin_in_c (c), .bin_in_d (d), .sn_out (sn_out_a),
       .ctr_overflow (ctr_ov_a));
  prg_8b_4in_lowmid prg_b(.clk (ctr_ov_a), .rst (rst), .en (en),
       .bin_in_a (a), .bin_in_b (b), .bin_in_c (c), .bin_in_d (d),
       .sn_out (sn_out_b), .ctr_overflow (ctr_ov_b));
  prg_8b_4in_highmid prg_c(.clk (ctr_ov_b), .rst (rst), .en (en),
       .bin_in_a (a), .bin_in_b (b), .bin_in_c (c), .bin_in_d (d),
       .sn_out (sn_out_c), .ctr_overflow (ctr_ov_c));
  prg_8b_4in_min prg_d(.clk (ctr_ov_c), .rst (rst), .en (en), .bin_in_a
