...
module prg_4b_trip(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
  ...
  wire clk, rst, en;
  wire [3:0] bin_in_a, bin_in_b, bin_in_c;
...
module prg_4b_3in_max(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [3:0] bin_in_a, bin_in_b, bin_in_c;
  ...
  prg_4b_trip prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
...
module prg_4b_trip_1(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out_a, sn_out_b, sn_out_c, ctr_overflow);
  input clk, rst, en;
  input [3:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  wire [3:0] ctr4_out;
  comp_4b_3 comp4_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_4b_4 comp4_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_4b_5 comp4_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  counter_WIDTH4_1 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_4b_3in_mid(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [3:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out, ctr_overflow;
  ...
  prg_4b_trip_1 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .sn_out_a (sn_out_a), .sn_out_b (sn_out_b), .sn_out_c
       (sn_out_c), .ctr_overflow (ctr_overflow));
...
module comp_4b_6(a_gt_b, a, b);
  ...
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6;
  comp_1b_24 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED6),
       .a_larger (agt_16));
...
module comp_4b_7(a_gt_b, a, b);
  ...
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6;
  comp_1b_28 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED7),
       .a_larger (agt_16));
...
module prg_4b_trip_2(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out_a, sn_out_b, sn_out_c, ctr_overflow);
  input clk, rst, en;
  input [3:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  wire [3:0] ctr4_out;
  comp_4b_6 comp4_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_4b_7 comp4_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_4b_8 comp4_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  counter_WIDTH4_2 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_4b_3in_min(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [3:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out, ctr_overflow;
  ...
  prg_4b_trip_2 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .sn_out_a (sn_out_a), .sn_out_b (sn_out_b), .sn_out_c
       (sn_out_c), .ctr_overflow (ctr_overflow));
...
module dsc_mul(a, b, c, z, clk, rst, en, ov);
  ...
  prg_4b_3in_max prg_a(.clk (clk), .rst (rst), .en (en), .bin_in_a (a),
       .bin_in_b (b), .bin_in_c (c), .sn_out (sn_out_a), .ctr_overflow
       (ctr_ov_a));
  prg_4b_3in_mid prg_b(.clk (ctr_ov_a), .rst (rst), .en (en), .bin_in_a
       (a), .bin_in_b (b), .bin_in_c (c), .sn_out (sn_out_b),
       .ctr_overflow (ctr_ov_b));
  prg_4b_3in_min prg_c(.clk (ctr_ov_b), .rst (rst), .en (en), .bin_in_a
