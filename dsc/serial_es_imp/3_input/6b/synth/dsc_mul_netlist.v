...
module prg_6b_trip(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
  ...
  wire clk, rst, en;
  wire [5:0] bin_in_a, bin_in_b, bin_in_c;
...
module prg_6b_3in_max(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [5:0] bin_in_a, bin_in_b, bin_in_c;
  ...
  prg_6b_trip prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
...
module prg_6b_trip_1(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out_a, sn_out_b, sn_out_c, ctr_overflow);
  input clk, rst, en;
  input [5:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  wire [5:0] ctr4_out;
  comp_6b_3 comp6_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_6b_4 comp6_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_6b_5 comp6_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  counter_WIDTH6_1 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_6b_3in_mid(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [5:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out, ctr_overflow;
  ...
  prg_6b_trip_1 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .sn_out_a (sn_out_a), .sn_out_b (sn_out_b), .sn_out_c
       (sn_out_c), .ctr_overflow (ctr_overflow));
...
module comp_6b_6(a_gt_b, a, b);
  ...
  wire e_13, e_14, e_15, e_16, n_0, n_1, n_2, n_3;
  wire n_4, n_5, n_6, n_7, n_8, n_9, n_10, n_11;
  comp_1b_36 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED6),
       .a_larger (agt_28));
...
module comp_6b_7(a_gt_b, a, b);
  ...
  wire [5:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED7, agt, agt_17, agt_19, agt_22, agt_25, agt_28, e;
  wire e_13, e_14, e_15, e_16, n_0, n_1, n_2, n_3;
  wire n_4, n_5, n_6, n_7, n_8, n_9, n_10, n_11;
  comp_1b_42 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED7),
       .a_larger (agt_28));
...
module prg_6b_trip_2(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out_a, sn_out_b, sn_out_c, ctr_overflow);
  input clk, rst, en;
  input [5:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  wire [5:0] ctr4_out;
  comp_6b_6 comp6_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_6b_7 comp6_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_6b_8 comp6_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  counter_WIDTH6_2 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_6b_3in_min(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [5:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out, ctr_overflow;
  ...
  prg_6b_trip_2 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .sn_out_a (sn_out_a), .sn_out_b (sn_out_b), .sn_out_c
       (sn_out_c), .ctr_overflow (ctr_overflow));
...
module counter_WIDTH18(out, clk, en, rst, overflow);
  ...
  increment_unsigned inc_add_36_16_1(.A (out), .CI (1'b1), .Z ({n_76,
       ...
       n_87, n_88, n_89, n_90, n_91, n_92, UNCONNECTED9}));
...
module dsc_mul(a, b, c, z, clk, rst, en, ov);
  ...
  prg_6b_3in_max prg_a(.clk (clk), .rst (rst), .en (en), .bin_in_a (a),
       .bin_in_b (b), .bin_in_c (c), .sn_out (sn_out_a), .ctr_overflow
       (ctr_ov_a));
  prg_6b_3in_mid prg_b(.clk (ctr_ov_a), .rst (rst), .en (en), .bin_in_a
       (a), .bin_in_b (b), .bin_in_c (c), .sn_out (sn_out_b),
       .ctr_overflow (ctr_ov_b));
  prg_6b_3in_min prg_c(.clk (ctr_ov_b), .rst (rst), .en (en), .bin_in_a
