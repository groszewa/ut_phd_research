...
module prg_10b_trip(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
  ...
  wire clk, rst, en;
  wire [9:0] bin_in_a, bin_in_b, bin_in_c;
...
module prg_10b_3in_max(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b, bin_in_c;
  ...
  prg_10b_trip prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
...
module prg_10b_trip_1(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out_a, sn_out_b, sn_out_c, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  wire [9:0] ctr4_out;
  comp_10b_3 comp10_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_10b_4 comp10_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_10b_5 comp10_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  counter_WIDTH10_1 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_10b_3in_mid(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out, ctr_overflow;
  ...
  prg_10b_trip_1 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .sn_out_a (sn_out_a), .sn_out_b (sn_out_b), .sn_out_c
       (sn_out_c), .ctr_overflow (ctr_overflow));
...
module comp_10b_6(a_gt_b, a, b);
  ...
  wire n_12, n_13, n_14, n_15, n_16, n_17, n_18, n_19;
  wire n_20, n_21;
  comp_1b_60 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED6),
       .a_larger (agt_52));
...
module comp_10b_7(a_gt_b, a, b);
  ...
  wire [9:0] a, b;
  wire a_gt_b;
  wire UNCONNECTED7, agt, agt_29, agt_31, agt_34, agt_37, agt_40,
       agt_43;
  wire agt_46, agt_49, agt_52, e, e_21, e_22, e_23, e_24;
  wire e_25, e_26, e_27, e_28, n_0, n_1, n_2, n_3;
  wire n_4, n_5, n_6, n_7, n_8, n_9, n_10, n_11;
  wire n_12, n_13, n_14, n_15, n_16, n_17, n_18, n_19;
  wire n_20, n_21;
  comp_1b_70 comp0(.a (a[0]), .b (b[0]), .equal (UNCONNECTED7),
       .a_larger (agt_52));
...
module prg_10b_trip_2(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out_a, sn_out_b, sn_out_c, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  ...
  wire sn_out_a, sn_out_b, sn_out_c, ctr_overflow;
  wire [9:0] ctr4_out;
  comp_10b_6 comp10_a(.a_gt_b (sn_out_a), .a (bin_in_a), .b (ctr4_out));
  comp_10b_7 comp10_b(.a_gt_b (sn_out_b), .a (bin_in_b), .b (ctr4_out));
  comp_10b_8 comp10_c(.a_gt_b (sn_out_c), .a (bin_in_c), .b (ctr4_out));
  counter_WIDTH10_2 ctr4(.out (ctr4_out), .clk (clk), .en (en), .rst
       (rst), .overflow (ctr_overflow));
endmodule

module prg_10b_3in_min(clk, rst, en, bin_in_a, bin_in_b, bin_in_c,
     sn_out, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in_a, bin_in_b, bin_in_c;
  output sn_out, ctr_overflow;
  ...
  prg_10b_trip_2 prg_ab(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (bin_in_a), .bin_in_b (bin_in_b), .bin_in_c (bin_in_c),
       .sn_out_a (sn_out_a), .sn_out_b (sn_out_b), .sn_out_c
       (sn_out_c), .ctr_overflow (ctr_overflow));
...
module increment_unsigned_3(A, CI, Z);
  ...
  XOR2X1 g203(.A (n_55), .B (A[29]), .Y (Z[29]));
  HAX1 g204(.A (A[28]), .B (n_53), .YC (n_55), .YS (Z[28]));
  HAX1 g205(.A (A[27]), .B (n_51), .YC (n_53), .YS (Z[27]));
  HAX1 g206(.A (A[26]), .B (n_49), .YC (n_51), .YS (Z[26]));
  HAX1 g207(.A (A[25]), .B (n_47), .YC (n_49), .YS (Z[25]));
  HAX1 g208(.A (A[24]), .B (n_45), .YC (n_47), .YS (Z[24]));
  HAX1 g209(.A (A[23]), .B (n_43), .YC (n_45), .YS (Z[23]));
  HAX1 g210(.A (A[22]), .B (n_41), .YC (n_43), .YS (Z[22]));
  HAX1 g211(.A (A[21]), .B (n_39), .YC (n_41), .YS (Z[21]));
  HAX1 g212(.A (A[20]), .B (n_37), .YC (n_39), .YS (Z[20]));
  HAX1 g213(.A (A[19]), .B (n_35), .YC (n_37), .YS (Z[19]));
  HAX1 g214(.A (A[18]), .B (n_33), .YC (n_35), .YS (Z[18]));
  HAX1 g215(.A (A[17]), .B (n_31), .YC (n_33), .YS (Z[17]));
  HAX1 g216(.A (A[16]), .B (n_29), .YC (n_31), .YS (Z[16]));
  HAX1 g217(.A (A[15]), .B (n_27), .YC (n_29), .YS (Z[15]));
  HAX1 g218(.A (A[14]), .B (n_25), .YC (n_27), .YS (Z[14]));
  HAX1 g219(.A (A[13]), .B (n_23), .YC (n_25), .YS (Z[13]));
  HAX1 g220(.A (A[12]), .B (n_21), .YC (n_23), .YS (Z[12]));
  HAX1 g221(.A (A[11]), .B (n_19), .YC (n_21), .YS (Z[11]));
  HAX1 g222(.A (A[10]), .B (n_17), .YC (n_19), .YS (Z[10]));
  HAX1 g223(.A (A[9]), .B (n_15), .YC (n_17), .YS (Z[9]));
  HAX1 g224(.A (A[8]), .B (n_13), .YC (n_15), .YS (Z[8]));
  HAX1 g225(.A (A[7]), .B (n_11), .YC (n_13), .YS (Z[7]));
  HAX1 g226(.A (A[6]), .B (n_9), .YC (n_11), .YS (Z[6]));
  HAX1 g227(.A (A[5]), .B (n_7), .YC (n_9), .YS (Z[5]));
  HAX1 g228(.A (A[4]), .B (n_5), .YC (n_7), .YS (Z[4]));
  HAX1 g229(.A (A[3]), .B (n_3), .YC (n_5), .YS (Z[3]));
  HAX1 g230(.A (A[2]), .B (n_1), .YC (n_3), .YS (Z[2]));
  HAX1 g231(.A (A[0]), .B (A[1]), .YC (n_1), .YS (Z[1]));
endmodule

module counter_WIDTH30(out, clk, en, rst, overflow);
  input clk, en, rst;
  output [29:0] out;
  output overflow;
  wire clk, en, rst;
  ...
  wire n_88, n_89, n_92, n_96, n_97, n_98, n_99, n_100;
  ...
  increment_unsigned_3 inc_add_36_16_2(.A (out), .CI (1'b1), .Z ({n_96,
       ...
       n_124, UNCONNECTED9}));
  INVX1 g52(.A (rst), .Y (n_92));
  DFFSR \out_reg[10] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_52), .Q
       (n_70));
  DFFSR \out_reg[11] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_55), .Q
       (n_71));
  DFFSR \out_reg[12] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_49), .Q
       (n_72));
  DFFSR \out_reg[24] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_59), .Q
       (n_84));
  DFFSR \out_reg[25] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_58), .Q
       (n_85));
  DFFSR \out_reg[26] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_57), .Q
       (n_86));
  DFFSR \out_reg[27] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_56), .Q
       (n_87));
  DFFSR \out_reg[28] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_54), .Q
       (n_88));
  DFFSR \out_reg[29] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_53), .Q
       (n_89));
  DFFSR \out_reg[2] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_51), .Q
       (n_62));
  DFFSR \out_reg[3] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_50), .Q
       (n_63));
  DFFSR \out_reg[13] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_46), .Q
       (n_73));
  DFFSR \out_reg[14] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_28), .Q
       (n_74));
  DFFSR \out_reg[4] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_48), .Q
       (n_64));
  DFFSR \out_reg[5] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_47), .Q
       (n_65));
  DFFSR \out_reg[6] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_45), .Q
       (n_66));
  DFFSR \out_reg[7] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_29), .Q
       (n_67));
  DFFSR \out_reg[15] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_27), .Q
       (n_75));
  DFFSR \out_reg[8] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_26), .Q
       (n_68));
  DFFSR \out_reg[9] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_25), .Q
       (n_69));
  DFFSR \out_reg[16] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_24), .Q
       (n_76));
  DFFSR \out_reg[17] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_23), .Q
       (n_77));
  DFFSR \out_reg[18] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_22), .Q
       (n_78));
  DFFSR \out_reg[19] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_21), .Q
       (n_79));
  DFFSR \out_reg[1] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_20), .Q
       (n_61));
  DFFSR \out_reg[20] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_19), .Q
       (n_80));
  DFFSR \out_reg[21] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_18), .Q
       (n_81));
  DFFSR \out_reg[22] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_17), .Q
       (n_82));
  DFFSR \out_reg[23] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_16), .Q
       (n_83));
  DFFSR \out_reg[0] (.R (n_92), .S (1'b1), .CLK (clk), .D (n_0), .Q
       (n_60));
  INVX1 g82(.A (n_44), .Y (n_59));
  INVX1 g83(.A (n_43), .Y (n_58));
  INVX1 g84(.A (n_42), .Y (n_57));
  INVX1 g85(.A (n_41), .Y (n_56));
  INVX1 g86(.A (n_40), .Y (n_55));
  INVX1 g87(.A (n_39), .Y (n_54));
  INVX1 g88(.A (n_38), .Y (n_53));
  INVX1 g89(.A (n_37), .Y (n_52));
  INVX1 g90(.A (n_36), .Y (n_51));
  INVX1 g91(.A (n_35), .Y (n_50));
  INVX1 g92(.A (n_34), .Y (n_49));
  INVX1 g93(.A (n_33), .Y (n_48));
  INVX1 g94(.A (n_32), .Y (n_47));
  INVX1 g95(.A (n_31), .Y (n_46));
  INVX1 g96(.A (n_30), .Y (n_45));
  MUX2X1 g97(.A (n_101), .B (out[24]), .S (en), .Y (n_44));
  MUX2X1 g98(.A (n_100), .B (out[25]), .S (en), .Y (n_43));
  MUX2X1 g99(.A (n_99), .B (out[26]), .S (en), .Y (n_42));
  MUX2X1 g100(.A (n_98), .B (out[27]), .S (en), .Y (n_41));
  MUX2X1 g101(.A (n_114), .B (out[11]), .S (en), .Y (n_40));
  MUX2X1 g102(.A (n_97), .B (out[28]), .S (en), .Y (n_39));
  MUX2X1 g103(.A (n_96), .B (out[29]), .S (en), .Y (n_38));
  MUX2X1 g104(.A (n_115), .B (out[10]), .S (en), .Y (n_37));
  MUX2X1 g105(.A (n_123), .B (out[2]), .S (en), .Y (n_36));
  MUX2X1 g106(.A (n_122), .B (out[3]), .S (en), .Y (n_35));
  MUX2X1 g107(.A (n_113), .B (out[12]), .S (en), .Y (n_34));
  MUX2X1 g108(.A (n_121), .B (out[4]), .S (en), .Y (n_33));
  MUX2X1 g109(.A (n_120), .B (out[5]), .S (en), .Y (n_32));
  MUX2X1 g110(.A (n_112), .B (out[13]), .S (en), .Y (n_31));
  MUX2X1 g111(.A (n_119), .B (out[6]), .S (en), .Y (n_30));
  INVX1 g112(.A (n_15), .Y (n_29));
  INVX1 g113(.A (n_14), .Y (n_28));
  INVX1 g114(.A (n_13), .Y (n_27));
  INVX1 g115(.A (n_12), .Y (n_26));
  INVX1 g116(.A (n_11), .Y (n_25));
  INVX1 g117(.A (n_10), .Y (n_24));
  INVX1 g118(.A (n_9), .Y (n_23));
  INVX1 g119(.A (n_8), .Y (n_22));
  INVX1 g120(.A (n_7), .Y (n_21));
  INVX1 g121(.A (n_6), .Y (n_20));
  INVX1 g122(.A (n_5), .Y (n_19));
  INVX1 g123(.A (n_4), .Y (n_18));
  INVX1 g124(.A (n_3), .Y (n_17));
  INVX1 g125(.A (n_2), .Y (n_16));
  MUX2X1 g126(.A (n_118), .B (out[7]), .S (en), .Y (n_15));
  MUX2X1 g127(.A (n_111), .B (out[14]), .S (en), .Y (n_14));
  MUX2X1 g128(.A (n_110), .B (out[15]), .S (en), .Y (n_13));
  MUX2X1 g129(.A (n_117), .B (out[8]), .S (en), .Y (n_12));
  MUX2X1 g130(.A (n_116), .B (out[9]), .S (en), .Y (n_11));
  MUX2X1 g131(.A (n_109), .B (out[16]), .S (en), .Y (n_10));
  MUX2X1 g132(.A (n_108), .B (out[17]), .S (en), .Y (n_9));
  MUX2X1 g133(.A (n_107), .B (out[18]), .S (en), .Y (n_8));
  MUX2X1 g134(.A (n_106), .B (out[19]), .S (en), .Y (n_7));
  MUX2X1 g135(.A (n_124), .B (out[1]), .S (en), .Y (n_6));
  MUX2X1 g136(.A (n_105), .B (out[20]), .S (en), .Y (n_5));
  MUX2X1 g137(.A (n_104), .B (out[21]), .S (en), .Y (n_4));
  MUX2X1 g138(.A (n_103), .B (out[22]), .S (en), .Y (n_3));
  MUX2X1 g139(.A (n_102), .B (out[23]), .S (en), .Y (n_2));
  BUFX2 drc_bufs262(.A (n_89), .Y (out[29]));
  BUFX2 drc_bufs263(.A (n_60), .Y (out[0]));
  BUFX2 drc_bufs264(.A (n_61), .Y (out[1]));
  BUFX2 drc_bufs265(.A (n_62), .Y (out[2]));
  BUFX2 drc_bufs266(.A (n_63), .Y (out[3]));
  BUFX2 drc_bufs267(.A (n_64), .Y (out[4]));
  BUFX2 drc_bufs268(.A (n_65), .Y (out[5]));
  BUFX2 drc_bufs269(.A (n_66), .Y (out[6]));
  BUFX2 drc_bufs270(.A (n_67), .Y (out[7]));
  BUFX2 drc_bufs271(.A (n_68), .Y (out[8]));
  BUFX2 drc_bufs272(.A (n_69), .Y (out[9]));
  BUFX2 drc_bufs273(.A (n_70), .Y (out[10]));
  BUFX2 drc_bufs274(.A (n_71), .Y (out[11]));
  BUFX2 drc_bufs275(.A (n_72), .Y (out[12]));
  BUFX2 drc_bufs276(.A (n_73), .Y (out[13]));
  BUFX2 drc_bufs277(.A (n_74), .Y (out[14]));
  BUFX2 drc_bufs278(.A (n_75), .Y (out[15]));
  BUFX2 drc_bufs279(.A (n_76), .Y (out[16]));
  BUFX2 drc_bufs280(.A (n_77), .Y (out[17]));
  BUFX2 drc_bufs281(.A (n_78), .Y (out[18]));
  BUFX2 drc_bufs282(.A (n_79), .Y (out[19]));
  BUFX2 drc_bufs283(.A (n_80), .Y (out[20]));
  BUFX2 drc_bufs284(.A (n_81), .Y (out[21]));
  BUFX2 drc_bufs285(.A (n_82), .Y (out[22]));
  BUFX2 drc_bufs286(.A (n_83), .Y (out[23]));
  BUFX2 drc_bufs287(.A (n_84), .Y (out[24]));
  BUFX2 drc_bufs288(.A (n_85), .Y (out[25]));
  BUFX2 drc_bufs289(.A (n_86), .Y (out[26]));
  BUFX2 drc_bufs290(.A (n_87), .Y (out[27]));
  BUFX2 drc_bufs291(.A (n_88), .Y (out[28]));
  XOR2X1 g2(.A (en), .B (out[0]), .Y (n_0));
endmodule
...
module dsc_mul(a, b, c, z, clk, rst, en, ov);
  ...
  prg_10b_3in_max prg_a(.clk (clk), .rst (rst), .en (en), .bin_in_a
       (a), .bin_in_b (b), .bin_in_c (c), .sn_out (sn_out_a),
       .ctr_overflow (ctr_ov_a));
  prg_10b_3in_mid prg_b(.clk (ctr_ov_a), .rst (rst), .en (en),
       .bin_in_a (a), .bin_in_b (b), .bin_in_c (c), .sn_out (sn_out_b),
       .ctr_overflow (ctr_ov_b));
  prg_10b_3in_min prg_c(.clk (ctr_ov_b), .rst (rst), .en (en),
       .bin_in_a (a), .bin_in_b (b), .bin_in_c (c), .sn_out (sn_out_c),
       .ctr_overflow (ctr_ov_c));
  counter_WIDTH30 stoch2bin_out(.out (z), .clk (clk), .en (sn_out_mul),
