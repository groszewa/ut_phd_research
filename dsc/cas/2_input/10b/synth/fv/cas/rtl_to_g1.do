...
usage -auto -elapse
set log file fv/cas/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/ut_phd_research/dsc/cas/2_input/10b/synth/../../../../shared/gscl45nm.lib
...
elaborate design -golden -root cas -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/cas/g1.v.gz
} else {
...
elaborate design -revised -root cas
