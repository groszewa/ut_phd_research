...
usage -auto -elapse
set log file fv/cas3/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/ut_phd_research/dsc/cas/3_input/10b/synth/../../../../shared/gscl45nm.lib
...
elaborate design -golden -root cas3 -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/cas3/g1.v.gz
} else {
...
elaborate design -revised -root cas3
...
write hier_compare dofile fv/cas3/hier_rtl_to_g1.do \
...
run hier_compare fv/cas3/hier_rtl_to_g1.do -dynamic_hierarchy
