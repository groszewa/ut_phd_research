...
create_generated_clock -source [get_ports clk] -name clk_int1 -divide_by 1 [get_pins /designs/dsc_serial_mul_DATA_WIDTH8_NUM_INPUTS2/instances_hier/genblk1[1].genblk1.sng/pins_in/clk]
