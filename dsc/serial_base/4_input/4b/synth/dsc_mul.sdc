...
create_generated_clock -source [get_ports clk] -name clk_int2 -divide_by 1 [get_pins /designs/dsc_mul/instances_hier/prg_c/pins_in/clk]
create_generated_clock -source [get_ports clk] -name clk_int3 -divide_by 1 [get_pins /designs/dsc_mul/instances_hier/prg_d/pins_in/clk]
