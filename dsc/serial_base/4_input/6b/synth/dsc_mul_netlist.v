...
module prg_6b_3(clk, rst, en, bin_in, sn_out, ctr_overflow);
  input clk, rst, en;
  input [5:0] bin_in;
  output sn_out, ctr_overflow;
  wire clk, rst, en;
  ...
  wire sn_out, ctr_overflow;
  wire [5:0] ctr4_out;
  comp_6b_3 comp6(.a_gt_b (sn_out), .a (bin_in), .b (ctr4_out));
...
module counter_WIDTH24(out, clk, en, rst, overflow);
  ...
  increment_unsigned inc_add_36_16_1(.A (out), .CI (1'b1), .Z ({n_96,
       ...
       n_115, n_116, n_117, n_118, UNCONNECTED3}));
...
module dsc_mul(a, b, c, d, z, clk, rst, en, ov);
  ...
  prg_6b_3 prg_d(.clk (ctr_ov_c), .rst (rst), .en (en), .bin_in (d),
