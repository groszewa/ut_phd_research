...
module prg_10b_3(clk, rst, en, bin_in, sn_out, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in;
  output sn_out, ctr_overflow;
  wire clk, rst, en;
  ...
  wire sn_out, ctr_overflow;
  wire [9:0] ctr4_out;
  comp_10b_3 comp10(.a_gt_b (sn_out), .a (bin_in), .b (ctr4_out));
...
module counter_WIDTH40(out, clk, en, rst, overflow);
  ...
  increment_unsigned_4 inc_add_36_16_2(.A (out), .CI (1'b1), .Z
       ...
       n_146, n_147, n_148, UNCONNECTED3}));
