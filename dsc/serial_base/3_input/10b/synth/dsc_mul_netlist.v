...
module comp_10b(a_gt_b, a, b);
  ...
  INVX1 g32(.A (e_22), .Y (n_21));
  INVX1 g33(.A (e), .Y (n_20));
  INVX1 g34(.A (e_26), .Y (n_19));
  INVX1 g35(.A (e_24), .Y (n_18));
  OAI21X1 g247(.A (n_20), .B (n_4), .C (n_5), .Y (a_gt_b));
  ...
  OAI21X1 g253(.A (n_19), .B (n_2), .C (n_6), .Y (n_12));
...
module prg_10b_2(clk, rst, en, bin_in, sn_out, ctr_overflow);
  input clk, rst, en;
  input [9:0] bin_in;
  output sn_out, ctr_overflow;
  wire clk, rst, en;
  ...
  wire sn_out, ctr_overflow;
  wire [9:0] ctr4_out;
  comp_10b_2 comp10(.a_gt_b (sn_out), .a (bin_in), .b (ctr4_out));
...
module dsc_mul(a, b, c, z, clk, rst, en, ov);
  ...
  prg_10b_2 prg_c(.clk (ctr_ov_b), .rst (rst), .en (en), .bin_in (c),
