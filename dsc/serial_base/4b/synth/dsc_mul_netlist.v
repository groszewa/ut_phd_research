...
module prg_4b_1(clk, rst, en, bin_in, sn_out, ctr_overflow);
  ...
  INVX1 drc_bufs145(.A (ctr_overflow), .Y (n_3));
...
module dsc_mul(a, b, z, clk, rst, en, ov);
  ...
  DFFSR \stoch2bin_out_out_reg[7] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_64), .Q (n_73));
  OAI21X1 g511(.A (n_33), .B (n_61), .C (n_2), .Y (n_64));
  DFFSR \stoch2bin_out_out_reg[6] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_63), .Q (n_72));
  INVX1 g513(.A (n_62), .Y (n_63));
  MUX2X1 g514(.A (z[6]), .B (n_60), .S (n_33), .Y (n_62));
  XNOR2X1 g515(.A (n_59), .B (z[7]), .Y (n_61));
  DFFSR \stoch2bin_out_out_reg[5] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_58), .Q (n_71));
  HAX1 g517(.A (z[6]), .B (n_55), .YC (n_59), .YS (n_60));
  INVX1 g518(.A (n_57), .Y (n_58));
  MUX2X1 g519(.A (z[5]), .B (n_56), .S (n_33), .Y (n_57));
  DFFSR \stoch2bin_out_out_reg[4] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_54), .Q (n_70));
  HAX1 g521(.A (z[5]), .B (n_51), .YC (n_55), .YS (n_56));
  INVX1 g522(.A (n_53), .Y (n_54));
  MUX2X1 g523(.A (z[4]), .B (n_52), .S (n_33), .Y (n_53));
  ...
  DFFSR prg_a_ctr4_overflow_reg(.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_46), .Q (ctr_ov_a));
  HAX1 g527(.A (z[4]), .B (n_43), .YC (n_51), .YS (n_52));
  INVX1 g528(.A (n_49), .Y (n_50));
  MUX2X1 g529(.A (z[3]), .B (n_44), .S (n_33), .Y (n_49));
  INVX1 g530(.A (n_47), .Y (n_48));
  MUX2X1 g531(.A (n_42), .B (n_9), .S (en), .Y (n_47));
  INVX1 g532(.A (n_45), .Y (n_46));
  MUX2X1 g533(.A (n_41), .B (ctr_ov_a), .S (en), .Y (n_45));
  ...
  DFFSR \stoch2bin_out_out_reg[0] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_1), .Q (n_66));
  HAX1 g537(.A (z[3]), .B (n_30), .YC (n_43), .YS (n_44));
  HAX1 g538(.A (n_9), .B (n_28), .YC (n_41), .YS (n_42));
  DFFSR \prg_a_ctr4_out_reg[2] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_35), .Q (prg_a_ctr4_out[2]));
  INVX1 g540(.A (n_39), .Y (n_40));
  MUX2X1 g541(.A (z[1]), .B (n_24), .S (n_33), .Y (n_39));
  INVX1 g542(.A (n_37), .Y (n_38));
  MUX2X1 g543(.A (z[2]), .B (n_31), .S (n_33), .Y (n_37));
  NAND2X1 g545(.A (z[7]), .B (n_33), .Y (n_36));
  INVX1 g546(.A (n_34), .Y (n_35));
  MUX2X1 g547(.A (n_29), .B (n_8), .S (en), .Y (n_34));
  OR2X1 g549(.A (n_16), .B (n_4), .Y (n_33));
  DFFSR \prg_a_ctr4_out_reg[1] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_27), .Q (prg_a_ctr4_out[1]));
  AOI22X1 g551(.A (n_25), .B (n_5), .C (a[3]), .D (n_10), .Y (n_32));
  HAX1 g552(.A (z[2]), .B (n_23), .YC (n_30), .YS (n_31));
  HAX1 g553(.A (n_8), .B (n_21), .YC (n_28), .YS (n_29));
  INVX1 g554(.A (n_26), .Y (n_27));
  MUX2X1 g555(.A (n_22), .B (n_6), .S (en), .Y (n_26));
  OAI21X1 g556(.A (n_7), .B (n_20), .C (n_3), .Y (n_25));
  DFFSR \prg_a_ctr4_out_reg[0] (.R (n_15), .S (1'b1), .CLK (clk), .D
       (n_0), .Q (prg_a_ctr4_out[0]));
  HAX1 g558(.A (z[1]), .B (z[0]), .YC (n_23), .YS (n_24));
  HAX1 g559(.A (n_6), .B (n_7), .YC (n_21), .YS (n_22));
  OAI21X1 g560(.A (a[1]), .B (n_11), .C (a[0]), .Y (n_20));
  AOI22X1 g561(.A (n_12), .B (a[2]), .C (a[1]), .D (n_11), .Y (n_19));
  AOI22X1 g562(.A (n_8), .B (n_17), .C (n_14), .D (n_9), .Y (n_18));
  INVX1 g584(.A (a[2]), .Y (n_17));
  INVX1 g585(.A (sn_out_b), .Y (n_16));
  INVX1 g586(.A (rst), .Y (n_15));
  INVX1 g587(.A (a[3]), .Y (n_14));
  INVX1 drc_bufs622(.A (n_9), .Y (n_10));
  INVX1 drc_bufs626(.A (n_8), .Y (n_12));
  INVX1 drc_bufs634(.A (n_6), .Y (n_11));
  BUFX2 drc_bufs640(.A (n_18), .Y (n_5));
  BUFX2 drc_bufs641(.A (n_32), .Y (n_4));
  BUFX2 drc_bufs642(.A (n_19), .Y (n_3));
  BUFX2 drc_bufs643(.A (n_36), .Y (n_2));
  BUFX2 drc_bufs644(.A (n_73), .Y (z[7]));
  BUFX2 drc_bufs645(.A (n_72), .Y (z[6]));
  BUFX2 drc_bufs646(.A (n_70), .Y (z[4]));
  BUFX2 drc_bufs647(.A (n_66), .Y (z[0]));
  BUFX2 drc_bufs649(.A (prg_a_ctr4_out[3]), .Y (n_9));
  BUFX2 drc_bufs650(.A (prg_a_ctr4_out[2]), .Y (n_8));
  BUFX2 drc_bufs651(.A (prg_a_ctr4_out[1]), .Y (n_6));
  BUFX2 drc_bufs652(.A (n_69), .Y (z[3]));
  BUFX2 drc_bufs653(.A (prg_a_ctr4_out[0]), .Y (n_7));
  BUFX2 drc_bufs654(.A (n_71), .Y (z[5]));
  BUFX2 drc_bufs655(.A (n_67), .Y (z[1]));
  BUFX2 drc_bufs656(.A (n_68), .Y (z[2]));
  XNOR2X1 g2(.A (n_33), .B (z[0]), .Y (n_1));
  XOR2X1 g674(.A (en), .B (n_7), .Y (n_0));
endmodule
