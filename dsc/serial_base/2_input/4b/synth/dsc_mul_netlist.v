...
module comp_4b(a_gt_b, a, b);
  ...
  OAI21X1 g71(.A (n_3), .B (n_1), .C (n_2), .Y (a_gt_b));
  AOI21X1 g72(.A (e_13), .B (n_5), .C (agt), .Y (n_6));
  INVX1 g73(.A (n_0), .Y (n_5));
  AOI21X1 g74(.A (agt_16), .B (e_19), .C (agt_11), .Y (n_4));
  INVX1 g75(.A (e), .Y (n_3));
  INVX1 g76(.A (agt_9), .Y (n_2));
  BUFX2 drc_bufs(.A (n_6), .Y (n_1));
  BUFX2 drc_bufs77(.A (n_4), .Y (n_0));
endmodule
