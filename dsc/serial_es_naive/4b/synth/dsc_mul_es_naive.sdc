current_design dsc_mul_es_naive
...
create_generated_clock -source [get_ports clk] -name clk_int -divide_by 1 [get_pins /designs/dsc_mul_es_naive/instances_hier/prg_b/pins_in/clk]
