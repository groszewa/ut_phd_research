...
usage -auto -elapse
set log file fv/dsc_mul_es_naive/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/ut_phd_research/dsc/serial_es_naive/4b/synth/../../../shared/gscl45nm.lib
...
elaborate design -golden -root dsc_mul_es_naive -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/dsc_mul_es_naive/g1.v.gz
} else {
...
elaborate design -revised -root dsc_mul_es_naive
