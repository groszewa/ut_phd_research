...
def compile():
    subprocess.call("vcs -full64 -o test_bench_tb file_reader_a.v file_reader_b.v file_writer.v multiplier.v test_bench.v test_bench_tb.v", shell=True)
...
def run_test(stimulus_a, stimulus_b):
    ...
    test = subprocess.Popen("sw_verif/test", stdin=subprocess.PIPE, stdout=subprocess.PIPE)
